<x-dynamic-component
  ...
  <div
    ...
    @if ($getImage())
      ...
      <button
        class="inline-flex items-center space-x-1 rtl:space-x-reverse text-sm font-medium focus:outline-none filament-tables-link text-primary-600 hover:text-primary-500"
        type="button"
...
<x-filament::modal
  ...
  <div class="flex flex-wrap sm:flex-nowrap">
    ...
    <main class="flex flex-col flex-1 w-full mt-12 sm:pt-6 sm:mt-0 ltr:sm:pl-8 rtl:sm:pr-8">
      {{-- Preview --}}
      <header class="w-full">
